...
package TheSysConExe "Thermal systems control exercise"
  ...
  package BaseClases "Base clases for thermal systems exercise"
    ...
    equation
      ...
      connect(case900Template.TSensor, comfort.TZon) annotation (Line(points={{
              76.8,32.4},{41.6,32.4},{41.6,108.678},{72,108.678}}, color={0,0,
              127}));
      connect(comfort.totDis, discomfort) annotation (Line(points={{90.9,
              109.454},{106,109.454},{106,100},{130,100}}, color={0,0,127}));
      connect(setpoints.CooSet, comfort.setCooExp) annotation (Line(points={{-61.1,
              114.236},{11.55,114.236},{11.55,114.116},{72,114.116}}, color={0,
              0,127}));
      connect(setpoints.HeaSet, comfort.setHeaExp) annotation (Line(points={{-61.1,
              103.273},{11.55,103.273},{11.55,103.24},{72,103.24}}, color={0,0,
              127}));
...
<li></li>
    ...
    model Tutorial "Building envelope model with two zones"
      extends IDEAS.Examples.Tutorial.Example5(
        rectangularZoneTemplate(redeclare OccSched occNum(k=0)),
        rectangularZoneTemplate1(redeclare OccSched occNum(k=0)))
      annotation (
        experiment(
          StartTime=10000000,
          StopTime=11000000,
